	...
	if (!prData) {
		return (
			<div className="error-container">
				...
				<button onClick={onBack}>Back to PR List</button>
			</div>
		);
	}
			...
			<div className="pr-card">
				...
				<div className="pr-metadata">
					...
					<div className="metadata-item">
						...
						<span className="metadata-value">{prData.source_branch}</span>
					</div>
					<div className="metadata-item">
						<span className="metadata-label">Target Branch</span>
						<span className="metadata-value">{prData.target_branch}</span>
					</div>
				</div>
