    ...
    try {
      ...
      const enhancedFiles = prFiles.map(file => {
        ...
        return {
          ...
          author: indexEntry ? indexEntry.created_by : 'Unknown Author',
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={
          <div className="center-container">
            ...
            <div className="directory-section">
              <button type="button" onClick={selectArchiveFile}>Select PR Archive File</button>
              <p className="selected-dir">{archiveFile || "No archive file selected"}</p>
            </div>
        ...
        <Route path="/pr/:prNumber" element={<PrDetails indexData={indexData} />} />
